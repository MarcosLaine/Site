...
export interface SkyToggleProps {
  /** When true, shows night/dark mode (checkbox checked). */
  checked?: boolean
  onCheckedChange?: (checked: boolean) => void
  className?: string
  /** `sm` aligns with navbar buttons (~36px tall). */
  size?: 'sm' | 'md'
  'aria-label'?: string
}
...
const StyledWrapper = styled.div`
  ...
  &[data-size='sm'] .theme-switch {
    --toggle-size: 16px;
    --container-width: 5.5em;
    --container-height: 2.25em;
    --circle-container-diameter: 3.15em;
